...
void loop(){
  ...
  if (incomingByte == 'v') {rele_test();} //testeo de reles
  if (incomingByte == 's') {servo_test();} //testeo de reles
  if (incomingByte == 'l') {servo_level();} //entrar al proceso de nivelacion
  if (incomingByte == 'n') {rele('2');}
  if (incomingByte == 'm') {rele('0');}
...
void display(){
  ...
  Serial.println("v: Test Reles");
  Serial.println("s: Test servos (descalibra!)");
  Serial.println("l: nivelacion placa");
